...
#define SUB_LINK_ENTRY "-e DllMainCRTStartup"
...
// #define TARGET_OVERRIDES_FORMAT_ATTRIBUTES mingw_format_attribute_overrides // FIXME
...
// #define TARGET_FORMAT_TYPES mingw_format_attributes // FIXME
